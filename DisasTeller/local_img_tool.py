...
content = [
    {"type": "text",
        "text": "describe the disaster in detail in the images, each image requires 200 words."
...
def local_img_interpreter(text: str) -> str:
    ...
    print("Local information:", content[0]["text"])

    try:
        response = client.chat.completions.create(
            model="gpt-4o-2024-05-13",  # or the model you are using model="gpt-4o-2024-08-06"
            messages=[
                {
                    "role": "user",
                    "content": content,
